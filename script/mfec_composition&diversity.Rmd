---
title: "mfec part composition and diversity analysis"
author: "xiaolin wang"
date: "2019-11-13"
...
#Phyla distributions and alpha-diversity across sample groups (mfec, fec, min7 vs Col-0)

##part1: Phyla distributions
...
pdf("../result/Figure_1D-phylum_natural_d5_average_barplot.pdf")
...
#######################Figure 1D
pdf("../result/Figure_1D-phylum_natural_endo_d5_average_barplot.pdf")
par(las=2, mar=c(6,4,2,15), xpd=T)
...
####
#######################Figure 2B
pdf("../result/Figure_2B-phylum_syncom_endo_d5_average_barplot.pdf")
par(las=2, mar=c(6,4,2,15), xpd=T)
...
##(2) genotype average diversity index
...
alpha_natural_total_d5_obs
ggsave("../result/Figure_S2A-natural_total_observed_obs_otus.pdf", alpha_natural_total_d5_obs, width = 3, height = 3)


###Figure_1C

alpha_natural_total_d5_shannon <-
...
alpha_natural_total_d5_shannon
ggsave("../result/Figure_1C-natural_total_shannon.pdf", alpha_natural_total_d5_shannon, width = 3, height = 3)



#########################################################
###Kruskal Wallis test and multiple comparison of treatments.
alpha_natural_total_sobs.fdr <- kruskal(alpha_natural_total_d5$observed_otus, alpha_natural_total_d5$Group, group=TRUE, p.adj="fdr")
alpha_natural_total_sobs.fdr

alpha_natural_total_shannon.fdr <- kruskal(alpha_natural_total_d5$shannon, alpha_natural_total_d5$Group, group=TRUE, p.adj="fdr")
alpha_natural_total_shannon.fdr
...
alpha_natural_endo_d5_obs
ggsave("../result/Figure_S2B-natural_endo_observed_obs_otus.pdf", alpha_natural_endo_d5_obs, width = 3, height = 3)


###Figure_2A
alpha_natural_endo_d5_shannon <- 
...
alpha_natural_endo_d5_shannon
ggsave("../result/Figure_1C-natural_endo_shannon.pdf", alpha_natural_endo_d5_shannon, width = 3, height = 3)

#########################################################
###Kruskal Wallis test and multiple comparison of treatments.
natural_endo_sobs.fdr <- kruskal(alpha_natural_endo_d5$observed_otus, alpha_natural_endo_d5$Group, group=TRUE, p.adj="fdr")
natural_endo_sobs.fdr

natural_endo_shannon.fdr <- kruskal(alpha_natural_endo_d5$shannon, alpha_natural_endo_d5$Group, group=TRUE, p.adj="fdr")
natural_endo_shannon.fdr
...
alpha_syncom_endo_d5_obs
ggsave("../result/Figure_S2B-syncom_endo_observed_obs_otus.pdf", alpha_syncom_endo_d5_obs, width = 3, height = 3)


###Figure_2A
alpha_syncom_endo_d5_shannon <- 
...
alpha_syncom_endo_d5_shannon
ggsave("../result/Figure_2A-syncom_endo_shannon.pdf", alpha_syncom_endo_d5_shannon, width = 3, height = 3)
...
bray_natural_total_d5_pcoa_ggplot2 <- 
...
bray_natural_endo_d5_pcoa_ggplot2 <- 
...
bray_syncom_endo_d5_pcoa_ggplot2 <- 
